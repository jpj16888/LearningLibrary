...
--设置归档日志传输方式 D:\oracle\archivelog 归档日志存放路径

alter system set log_archive_dest_1='LOCATION=D:\oracle\archivelog valid_for=(all_logfiles,all_roles) db_unique_name=primary' scope=spfile;
...
alter system set db_file_name_convert='D:\oracle\oradata\orcl','D:\oracle\oradata\orcl' scope=spfile;

--和上面同样的设置

alter system set log_file_name_convert='D:\oracle\oradata\orcl','D:\oracle\oradata\orcl' scope=spfile;
...
alter database add standby logfile group 4 ('D:\oracle\oradata\orcl\REDO04.LOG') size 50m;

alter database add standby logfile group 5 ('D:\oracle\oradata\orcl\REDO05.LOG') size 50m;

alter database add standby logfile group 6 ('D:\oracle\oradata\orcl\REDO06.LOG') size 50m;

alter database add standby logfile group 7 ('D:\oracle\oradata\orcl\REDO07.LOG') size 50m;
...
alter system set log_archive_dest_1='LOCATION=D:\oracle\archivelog valid_for=(all_logfiles,all_roles) db_unique_name=standby' scope=spfile;
